...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', dest='inputdir',
                        type=str, help='location of input dir.')
    parser.add_argument('-o', '--output', dest='output',
                        type=str, help='location of output file.')
    parser.add_argument('-e', '--extension', dest='extension', type=str, default=None,
                        help='Extension of the files e.g. \'.txt\'.If you want files with no extensions use -1')
